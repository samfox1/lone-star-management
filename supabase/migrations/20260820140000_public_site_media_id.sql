-- The media payload gains `id` (ftbk connection): two-way selection routes an image
-- item by its media row id (`data-lse-item="image:<id>"`), and the wire carried none.
-- Additive; null on revisions published before `id` joined the snapshot list.
-- Reproduced verbatim from 20260820130000 with ONE line added.
