 ...
 * area before reading a single number; the three figures beside it are the
 * legend. Sam, 2026-09-13: "a more unique visual … I am down to incorporate a
 * little red." The colours are fixed per device — mobile the blue accent,
