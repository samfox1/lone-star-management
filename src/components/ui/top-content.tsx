 ...
 * not, and an empty tab says which of those two it is — "none named a date yet"
 * is a different fact from "no ticket clicks", and a manager acts on them
 * differently. The tabs are derived from CONTENT_KINDS; nothing here knows the
 * word "song".
 */
