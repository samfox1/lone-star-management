/**
 * US states + DC as two-letter codes, for the tour-date State dropdown. The code is
 * what's stored and displayed ("Austin, TX"); the name is only for the dropdown label
 * so the list is scannable. Codes match the DB CHECK on `tour_dates.state` (two
 * uppercase letters).
 */
