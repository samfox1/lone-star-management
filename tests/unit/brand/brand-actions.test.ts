...
import { fakeClient, filterValue, isOwnershipRead, type Call, type Reply } from '@tests/unit/brand/_fake-client'
...
type Actions = typeof import('@/app/artists/[id]/(dashboard)/brand/actions')
const load = (): Promise<Actions> => import('@/app/artists/[id]/(dashboard)/brand/actions')
