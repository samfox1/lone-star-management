...
/**
 * lib/manager-tools/brand/brand-colors.ts, the built-in colours (20260924130000), over the fake client — no
 * database. What the live constraints hold is pinned by
 * tests/integration/manager-tools/brand/brand-colors-slots.test.ts; this pins what the lib does with it:
 *
