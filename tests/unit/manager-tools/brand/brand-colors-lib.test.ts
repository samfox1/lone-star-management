...
/**
 * lib/manager-tools/brand/brand-colors.ts over the PostgREST-shaped fake (no database). The action suite
 ...
 *     fallback sentence.
 * The CHECKs, the cap and RLS themselves are the live suite's (tests/integration/manager-tools/brand).
 */
