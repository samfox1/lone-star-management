...
describe('a routed select is VISIBLE where it lands', () => {
  ...
  it('CRITICAL: a polaroid select scrolls its slot tile into view', () => {
    ...
    renderInspector({
      ...
      photos: [{ id: 'p3', storage_path: 'artist-1/gallery/p3.jpg', onSite: true, orientation: 'horizontal', siteRole: 'polaroid_3_photo', collection: null, label: null, alt: null, kind: null }],
