...
function makeData(site_content: Record<string, string>): SiteData {
  return {
    ...
    tracks: [
      { id: 't', title: 'Song', cover_url: null, stream_url: null, provider_url: null, apple_url: null, has_audio: false, featured_artists: [], album_name: null, release_id: null, sort_order: 0, source: null, spotify_id: null, apple_id: null, deezer_id: null },
    ],
    tour_dates: [],
    merch: [],
    links: [],
