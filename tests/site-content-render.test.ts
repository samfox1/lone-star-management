...
function makeData(site_content: Record<string, string>): SiteData {
  return {
    ...
    tracks: [
      { id: 't', title: 'Song', cover_url: null, stream_url: null, provider_url: null, apple_url: null, has_audio: false, featured_artists: [], album_name: null, release_id: null, sort_order: 0 },
    ],
    tour_dates: [],
    merch: [],
    links: [],
