 ...
 * suites (tests/unit/manager-tools/brand/):
...
import { addBrandColor, deleteBrandColor, listBrandColors, renameBrandColor, setBrandColorHex } from '@/lib/manager-tools/brand/brand-colors'
 ...
 * (tests/unit/manager-tools/brand/brand-revert.test.ts) simulates the slot cascade; only the real schema
