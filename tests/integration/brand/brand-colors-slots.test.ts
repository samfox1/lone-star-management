...
/**
 * 20260924130000_brand_color_slots.sql against the hosted project, plus lib/brand-colors.ts
 * over it. The DB-free half (order, payload) is tests/unit/brand/brand-color-slots.test.ts.
 *
...
import { listBrandColors, renameBrandColor, setBrandColorNote, setSlotColor } from '@/lib/brand-colors'
