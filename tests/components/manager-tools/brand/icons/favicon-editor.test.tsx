 ...
 * (@tests/components/manager-tools/brand/icons/_canvas). That is the point, not a limitation: what
...
import { canvas, drain, installCanvasFakes, lastDrawAt, LOGO, pass, settle } from '@tests/components/manager-tools/brand/icons/_canvas'
...
import { saveFramingAction, setBrandAssetAction } from '@/app/artists/[id]/(dashboard)/(manager-tools)/brand/actions'
...
function Editor({ framing, closable = false }: { framing: FaviconFraming; closable?: boolean }) {
  ...
  return open ? (
    <IconEditor
      ...
      // never-generated case is pinned in tests/components/manager-tools/brand/icons/icon-editor.test.tsx.
      generated
