...
import { BOARD_BACKGROUNDS, ModalBoard } from '@/app/artists/[id]/(dashboard)/(manager-tools)/brand/_ui/modal-board'
import { BrandModal } from '@/app/artists/[id]/(dashboard)/(manager-tools)/brand/_ui/brand-modal'
...
describe('ModalBoard', () => {
  ...
  it('CRITICAL: the circles\' hover labels prefer ABOVE them and name them', () => {
    // The chip itself is portaled (tests/components/manager-tools/shared/hover-label.test.tsx); the
