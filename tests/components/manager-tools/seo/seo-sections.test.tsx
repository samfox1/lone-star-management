...
import { ListingSection } from '@/app/artists/[id]/(dashboard)/(manager-tools)/tools/seo/sections/listing'
import { FactsSection } from '@/app/artists/[id]/(dashboard)/(manager-tools)/tools/seo/sections/facts'
import { AboutSection } from '@/app/artists/[id]/(dashboard)/(manager-tools)/tools/seo/sections/about'
import { AiSection, probePrompts } from '@/app/artists/[id]/(dashboard)/(manager-tools)/tools/seo/sections/ai'
