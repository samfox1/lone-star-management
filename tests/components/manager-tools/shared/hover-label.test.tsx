...
/**
 * HoverLabel ((manager-tools)/_ui/row-icon.tsx). What has to hold:
 ...
 *   - it is placed by placeLabel (pure, tests/unit/manager-tools/shared/label-placement.test.ts) from the
