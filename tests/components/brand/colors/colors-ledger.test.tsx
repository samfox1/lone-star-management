...
import { ColorsLedger } from '@/app/artists/[id]/(dashboard)/brand/colors/colors-ledger'
import {
  addBrandColorAction,
...
import { COLOR_SLOTS, COLOR_SLOT_NAMES, MAX_ADDED_COLORS, MAX_BRAND_COLORS, type BrandColor } from '@/lib/brand-colors'
