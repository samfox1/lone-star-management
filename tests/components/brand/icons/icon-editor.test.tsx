 ...
 * tests/components/site-editor/favicon-editor.test.tsx. This file pins what is NEW: the
...
import { canvas, drain, hold, installCanvasFakes, lastDrawAt, LOGO, pass, settle } from '@tests/components/brand/icons/_canvas'
...
import * as actions from '@/app/artists/[id]/(dashboard)/brand/actions'
