...
import { SettingsView } from '@/app/artists/[id]/(dashboard)/settings/settings-view'
import { saveArtistNameAction, saveBookingEmailAction } from '@/app/artists/[id]/(dashboard)/settings/actions'
import { toast } from '@/app/artists/[id]/(dashboard)/toast'
import type { SettingsRow } from '@/lib/settings'

vi.mock('@/app/artists/[id]/(dashboard)/settings/actions', () => ({
