...
import { CATEGORY_CODE, GOOGLE_FAMILY_RE, MAX_GOOGLE_FAMILY, type GoogleFontRow } from '../src/lib/google-fonts'

const SOURCE = 'https://fonts.google.com/metadata/fonts'
const OUT = 'src/data/google-fonts.json'

type Family = { family: string; category: string; popularity: number }
...
async function main() {
  ...
  const rows: GoogleFontRow[] = [...families]
